...
def test(sayi,deneme):
	deneme=deneme

	if sayi==1:
		print(deneme)
		return 1
	test(sayi-1,deneme-1)

test(10,5)

#next ile gidilecek copy kullanılacak büyüklüğü alınarak ona göre bir sonraki teste ordan başlanacak
#fonsiyon, next hata veridğinide tekrar başlatılacak